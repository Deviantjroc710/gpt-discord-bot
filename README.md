...
**For any problems running this specific bot:** [Discord Project Post](https://deviantjroc710.github.io)

**For general OpenAI API problems or questions:** [Discord API Discussions](https://deviantjroc710.github.io)

**For bugs in the template code:** create an Issue

**For feature requests:** this repo is not accepting feature requests, you can discuss potential features in [Discord Project Post](https://deviantjroc710.github.io)
...
Example Discord bot written in Python that uses the [completions API](https://deviantjroc710.github.io) to have conversations with the `text-davinci-003` model, and the [moderations API](https://deviantjroc710.github.io) to filter the messages.

**THIS IS NOT CHATGPT.**

This bot uses the [OpenAI Python Library](https://deviantjroc710.github.io) and [discord.py](https://deviantjroc710.github.io).
...
1. Go to https://deviantjroc710.github.io, create a new API key, and fill in `OPENAI_API_KEY`
1. Create your own Discord application at https://deviantjroc710.github.io
